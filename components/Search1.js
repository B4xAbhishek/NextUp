  ...
  return (
    <View style={styles.search}>
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/oval-copy11.png")}
      />
      <Image
      ...
      <View style={[styles.gamesParent, styles.gamesPosition1]}>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/ellipse-6902.png")}
        />
        <Image
          style={styles.chicagoBullsLogoIcon}
          contentFit="cover"
          source={require("../assets/chicago-bulls-logo4.png")}
        />
      </View>
      <View style={[styles.gamesGroup, styles.gamesPosition1]}>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/los-angeles-lakers-logo21.png")}
        />
      </View>
      <LinearGradient
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/rectangle-188961.png")}
      />
      <LinearGradient
        style={[styles.searchChild, styles.searchLayout]}
        locations={[0, 1]}
