...
const GameDetailsScreenOverview = () => {
  ...
  return (
    <View style={styles.gameDetailsScreenOverview}>
      ...
      <Pressable
        style={styles.group}
        onPress={() => navigation.navigate("GameDetailsScreenOverview1")}
      >
      ...
      <ContainerCardForm
        imageDimensions={require("../assets/group-10000028561.png")}
      />
      <Image
      ...
      />
      <FormContainer1
        imageDimensions={require("../assets/group-10000028571.png")}
      />
      <Image
      ...
      <View style={[styles.rectangleParent, styles.groupChildLayout5]}>
        ...
        <Text style={[styles.bulls2, styles.bullsTypo1]}>Starters</Text>
        <Text style={[styles.bulls3, styles.bullsTypo1]}>Min</Text>
        <Text style={[styles.bulls4, styles.bullsTypo1]}>FG</Text>
        <Text style={[styles.bulls5, styles.bullsTypo1]}>3PT</Text>
        <Text style={[styles.bulls6, styles.bullsTypo1]}>AST</Text>
        <Text style={[styles.bulls7, styles.bullsTypo1]}>PF</Text>
        <Text style={[styles.bulls8, styles.bullsTypo1]}>PTS</Text>
      </View>
      ...
      <View style={[styles.rectangleContainer, styles.groupChildLayout5]}>
        <View style={[styles.groupChild, styles.groupChildLayout5]} />
        <Text style={[styles.bulls2, styles.bullsTypo1]}>Bench</Text>
        <Text style={[styles.bulls3, styles.bullsTypo1]}>Min</Text>
        <Text style={[styles.bulls4, styles.bullsTypo1]}>FG</Text>
        <Text style={[styles.bulls5, styles.bullsTypo1]}>3PT</Text>
        <Text style={[styles.bulls6, styles.bullsTypo1]}>AST</Text>
      ...
      <View style={[styles.rectangleCopyParent, styles.rectanglePosition]}>
        ...
        <Image
          style={styles.chicagoBullsLogoIcon1}
          contentFit="cover"
      ...
      <View style={[styles.rectangleCopyGroup, styles.rectanglePosition]}>
        ...
        <View style={[styles.pointsParent, styles.pointsParentPosition]}>
          <Text style={[styles.points, styles.textTypo8]}>2 points</Text>
        ...
        <View style={[styles.pointsGroup, styles.pointsParentPosition]}>
          <Text style={[styles.points, styles.textTypo8]}>3 points</Text>
          <View style={[styles.parent, styles.parentLayout]}>
            <Text style={[styles.text12, styles.textTypo3]}>0</Text>
            <Text style={[styles.text13, styles.textTypo3]}>0</Text>
            <Image
        ...
        <View style={[styles.freeThrowsParent, styles.pointsParentPosition]}>
          <Text style={[styles.freeThrows, styles.textTypo8]}>Free throws</Text>
...
export default GameDetailsScreenOverview;
