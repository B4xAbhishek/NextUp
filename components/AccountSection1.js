  ...
  return (
    ...
    >
      ...
      <View style={[styles.myStandingParent, styles.parentPosition]}>
        <Text style={[styles.explore, styles.homeTypo]}onPress={() => navigation.navigate("MyTeam1")}onPress={() => navigation.navigate("MyTeam1")}onPress={() => navigation.navigate("MyTeam1")}onPress={() => navigation.navigate("MyTeam1")}onPress={() => navigation.navigate("MyTeam1")}>My Team</Text></Text></Text>
        <Image
