  ...
  return (
    <View style={styles.playerContent}>
      ...
      <View style={styles.lebronJamesParent}>
        <Text style={styles.lebronJames}>Lebron James 0</Text>
      ...
      <Text style={[styles.warriors, styles.bullsTypo]} onPress={() => navigation.navigate("MyTeam1")}>My Team</Text>
      ...
      <View style={[styles.photoParent, styles.photoParentBg]}>
        ...
        >
          <Text style={styles.photoTypo}>Challenge</Text>
        </Pressable>
      </View>
    </View>
  );
