  ...
  return (
    <View style={styles.tellUsMoreFilledBoy}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("TellUsMoreFilledBoy")}
      >
        <Text style={styles.kumarTypo}>Albemarle School</Text>
        <Text style={styles.kumarTypo}>Old School</Text>
      </Pressable>
...
export default TellUsMoreFilledBoy1;
