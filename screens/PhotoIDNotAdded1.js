...
const PhotoIDNotAdded1 = () => {

  const navigation = useNavigation();

  const handleButtonClick = () => {
    navigation.navigate("PlayerDashboard1");
  };
...
`}</Text>
      ...
      <View style={[styles.rectangleCopy3Parent, styles.rectangleLayout]}>
        ...
        <Text onPress={handleButtonClick} style={[styles.continue, styles.continueLayout]}>Continue1</Text>
      </View>
      <Text onPress={handleSkipClick} style={[styles.skip, styles.skipFlexBox]}>Skip1</Text>
      <Image
      ...
      <View style={[styles.forProfileVerificaParent, styles.rectangleLayout1]}>
        <Text
          style={[styles.forProfileVerifica, styles.toGetYourTypo]}
        >{`Your document is under verification, We
will notify once verified.
`}</Text>
        <Image
      ...
      <Image
        style={[styles.groupIcon, styles.continueLayout]}
        contentFit="cover"
...
export default PhotoIDNotAdded1;
