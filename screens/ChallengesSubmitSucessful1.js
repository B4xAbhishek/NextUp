...
const ChallengesSubmitSucessful1 = () => {
  return (
    <View style={styles.challengesSubmitSucessful}>
      ...
      <Text style={[styles.woooHooo, styles.timeTypo]}>Wooo hooo!</Text>
      <Text
        style={[styles.congratulationYourChallenge, styles.continueTypo]}
      >{`Congratulation Your challenge has been
submitted successfully!`}</Text>
      ...
      >
        <View style={[styles.rectangleCopy3Group, styles.rectangleLayout]}>
          ...
          <Text style={[styles.continue1, styles.continueTypo]}>Ok!</Text>
        </View>
      </View>
      <Image
        style={styles.searchResultsForCheckmark}
        contentFit="cover"
        source={require("../assets/search-results-for-checkmark--flaticon2-1.png")}
      />
    </View>
  );
};
...
export default ChallengesSubmitSucessful1;
