...
ID`}</Text>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("PhotoIDNotAdded")}
      >
        <View style={[styles.rectangleCopy3, styles.rectangleLayout]} />
        <Text style={[styles.continue, styles.skipFlexBox]}>Continue</Text>
      </Pressable>
      <Text onPress={handleSkipClick} style={[styles.skip, styles.skipFlexBox]}>Skip2</Text>
    </View>
  );
};
...
export default PhotoIDNotAdded2;
