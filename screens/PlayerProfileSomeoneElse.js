...
const PlayerProfileSomeoneElse = () => {
  ...
  return (
    <View style={styles.playerProfileSomeoneElse}>
      ...
      <Text style={[styles.bulls, styles.warriorsPosition]}>Stats1</Text>
      <Pressable
        style={[styles.warriors, styles.warriorsPosition]}
        onPress={() => navigation.navigate("PlayerRoadToPro")}
      >
        <Text style={styles.roadToProTypo} onPress={() => navigation.navigate("PlayerRoadToPro")}>Road to Pro</Text>
      </Pressable>
      <Text style={[styles.warriors1, styles.roadToProTypo]} onPress={() => navigation.navigate("PlayerContent1")}>Content</Text>
      <Image
