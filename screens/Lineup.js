...
const Lineup = () => {
  return (
    <View style={styles.lineup}>
      ...
      <View style={[styles.lineupChild, styles.capacityBg]} />
      <Text style={styles.bulls}>About</Text>
      <View style={[styles.warriorsParent, styles.parentFlexBox]}>
        <Text style={[styles.warriors, styles.warriorsTypo1]}>Roster</Text>
        <Text style={[styles.warriors1, styles.warriorsTypo]}>Stats</Text>
        <Text style={[styles.warriors1, styles.warriorsTypo]}>Games</Text>
        <Text style={[styles.warriors3, styles.warriors3Typo]}>Lineup</Text>
      </View>
      ...
      <View style={styles.rectangleCopyParent}>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/ellipse-6892.png")}
        />
        <Image
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/ellipse-6912.png")}
        />
        <Image
      ...
      <View style={[styles.rectangleCopyGroup, styles.rectangleLayout]}>
        ...
        <View style={[styles.ellipseGroup, styles.ellipseLayout]}>
          ...
          <Image
            style={[styles.groupChild3, styles.groupChildPosition1]}
            contentFit="cover"
            source={require("../assets/ellipse-6893.png")}
          />
          <Image
            style={[styles.groupChild4, styles.groupChildPosition1]}
            contentFit="cover"
          ...
          <Image
            style={[styles.groupChild5, styles.groupChildPosition1]}
            contentFit="cover"
            source={require("../assets/ellipse-6913.png")}
          />
          <Image
            style={[styles.groupChild6, styles.groupChildPosition1]}
            contentFit="cover"
